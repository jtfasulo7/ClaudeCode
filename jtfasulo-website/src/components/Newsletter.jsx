      ...
      {status === 'success' ? (
        ...
        >
          ...
          <button
            ...
            className="h-12 px-6 rounded-xl bg-accent text-background font-semibold text-sm tracking-wide uppercase transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.3)] hover:-translate-y-px disabled:opacity-50 flex items-center justify-center gap-2 flex-shrink-0"
          >
            {status === 'loading' ? (
      ...
      <main>
        ...
        <section className="relative min-h-[85vh] flex items-center overflow-hidden">
          ...
          <div
            ...
            style={{
              background: `radial-gradient(ellipse 50% 50% at ${30 + mouseX * 40}% ${30 + mouseY * 40}%, rgba(6,182,212,0.08) 0%, transparent 70%), radial-gradient(ellipse 40% 40% at 70% 60%, rgba(59,130,246,0.04) 0%, transparent 70%)`,
            }}
          />
        ...
        <section className="py-24 lg:py-32 relative">
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse 50% 60% at 50% 100%, rgba(6,182,212,0.06) 0%, transparent 70%)',
            }}
          />
